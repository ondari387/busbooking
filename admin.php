...
?>
	<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="mt-3 form col-md-4 m-auto">
	  ...
	  <button type="submit" class="btn btn-block btn-primary mb-2" name="submit" href="index.php">Login</button>
	  <a href="adminregister.php" class="text-left mt-3">Create an admin account</a>
	</form>